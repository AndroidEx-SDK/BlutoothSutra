...
import com.androidex.basebluetooth.callback.IPairCallback;
import com.androidex.basebluetooth.callback.IScanCallback;
import com.androidex.basebluetooth.receiver.PairBroadcastReceiver;
import com.androidex.basebluetooth.receiver.ScanBroadcastReceiver;
import com.androidex.basebluetooth.utils.BluetoothUtil;
import com.androidex.bluetooth.R;
import com.androidex.bluetooth.adapter.AddFriendAdapter;
...
public class AddFriendActivity extends BaseChatActivity {
    ...
    private final IScanCallback<BluetoothDevice> scanCallback = new IScanCallback<BluetoothDevice>() {
        ...
        public void scanTimeout() {
            ...
            ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.no_found_friend));
        }
    ...
    private final IPairCallback pairCallback = new IPairCallback() {
        ...
        public void bonded() {
            ...
            LogUtils.i("bonded");
            ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.add_friend_success));
            finish();
        }
        ...
        public void bondFail() {
            ...
            LogUtils.i("bondFail");
            ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.add_friend_fail));
        }
    };
    ...
    protected void initWidget() {
        ...
        ((TextView)findViewById(R.id.title)).setText(getString(com.androidex.bluetooth.R.string.add_friend));
        ...
        mAddFriendLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(mBluetoothDevices.get(position).getBondState() != BluetoothDevice.BOND_BONDED){
                    ...
                    mProgressDialog.setMessage(getString(com.androidex.bluetooth.R.string.add_friend_loading));
                    mProgressDialog.show();
                } else{
                    ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.already_is_friend));
                }
            }
        });
    }
