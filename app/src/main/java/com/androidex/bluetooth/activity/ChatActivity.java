...
import com.androidex.basebluetooth.CommandHelper;
import com.androidex.basebluetooth.callback.IChatCallback;
import com.androidex.basebluetooth.common.ChatConstant;
import com.androidex.basebluetooth.common.State;
import com.androidex.basebluetooth.mode.BaseMessage;
import com.androidex.basebluetooth.mode.FileMessage;
import com.androidex.basebluetooth.utils.HexUtil;
import com.androidex.bluetooth.adapter.ChatAdapter;
...
import com.androidex.utils.config.LogUtils;
...
public class ChatActivity extends BaseChatActivity implements EmojiconsFragment.OnEmojiconBackspaceClickedListener,
    ...
    private IChatCallback<byte[]> chatCallback = new IChatCallback<byte[]>() {
        ...
        public void connectStateChange(State state) {
            ...
            if(state == State.STATE_CONNECTED){
                ...
                if(mFriendInfo != null){
                    mTitleTv.setText(mFriendInfo.getFriendNickName()+"("+getString(com.androidex.bluetooth.R.string.device_online)+")");
                }
                ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.connect_friend_success));
            }
        }
        ...
        public void showMessage(String message, int code) {
            ...
            ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.connect_friend_fail));
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.androidex.bluetooth.R.layout.activity_bluetooth_chat);
    }
    ...
    protected void initWidget() {
        ...
        mTitleTv = (TextView) findViewById(com.androidex.bluetooth.R.id.title);
        mChatMsgLv = (ListView) findViewById(com.androidex.bluetooth.R.id.chat_msg_show_list);
        mMsgFaceIb = (ImageButton) findViewById(com.androidex.bluetooth.R.id.chat_msg_face);
        mMsgAddIb = (ImageButton) findViewById(com.androidex.bluetooth.R.id.chat_msg_add);
        mMsgEditEt = (EditText) findViewById(com.androidex.bluetooth.R.id.chat_msg_edit);
        mMsgSendIb = (ImageButton) findViewById(com.androidex.bluetooth.R.id.chat_msg_send);
        mEmojiconFl = (FrameLayout) findViewById(com.androidex.bluetooth.R.id.chat_emojicons);
    ...
    protected void initData() {
        ...
        if(mFriendInfo.isOnline()){
            ...
            mTitleTv.setText(mFriendInfo.getFriendNickName()+"("+getString(com.androidex.bluetooth.R.string.device_offline)+")");
        }
        ...
        mProgressDialog.setMessage(getString(com.androidex.bluetooth.R.string.connect_friend_loading));
        ...
        mMsgSendIb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mMsgEditEt.getText() != null && mMsgEditEt.getText().toString().trim().length() > 0){
                    ...
                    ToastUtil.showLong(mContext, getString(com.androidex.bluetooth.R.string.send_msg_isEmpty));
                }
            }
        });
    ...
    private void setEmojiconFragment(boolean useSystemDefault) {
        getSupportFragmentManager()
                .beginTransaction()
                .replace(com.androidex.bluetooth.R.id.chat_emojicons, EmojiconsFragment.newInstance(useSystemDefault))
                .commit();
    }
