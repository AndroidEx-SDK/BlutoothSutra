...
public class GroupFriendAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(com.androidex.bluetooth.R.layout.item_group_info, null);
            groupViewHolder = new GroupViewHolder();
            groupViewHolder.nameTv = (TextView) convertView.findViewById(com.androidex.bluetooth.R.id.item_group_name);
            groupViewHolder.iconIv = (ImageView) convertView.findViewById(com.androidex.bluetooth.R.id.item_group_icon);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(com.androidex.bluetooth.R.layout.item_friend_info, null);
            friendViewHolder = new FriendViewHolder();
            friendViewHolder.iconIv = (ImageView) convertView.findViewById(com.androidex.bluetooth.R.id.item_friend_icon);
            friendViewHolder.nameTv = (TextView) convertView.findViewById(com.androidex.bluetooth.R.id.item_friend_name);
            friendViewHolder.addressTv = (TextView) convertView.findViewById(com.androidex.bluetooth.R.id.item_friend_address);
            friendViewHolder.statusTv = (TextView) convertView.findViewById(com.androidex.bluetooth.R.id.item_friend_status);
        ...
        if(friendInfo.isOnline()){
            friendViewHolder.statusTv.setText(context.getString(com.androidex.bluetooth.R.string.device_online));
        } else{
            friendViewHolder.statusTv.setText(context.getString(com.androidex.bluetooth.R.string.device_offline));
        }
        return convertView;
    }
