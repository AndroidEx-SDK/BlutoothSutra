package com.androidex.utils.file;
...
import com.androidex.log.ViseLog;
...
public class SdCardUtil {
    ...
    public static String getSDCardPath() {
            ...
            while ((lineStr = bufferedReader.readLine()) != null) {
                ...
                if (lineStr.contains("sdcard")
                    ...
                    if (strArray.length >= 5) {
                        ...
                        ViseLog.i("find sd card path:   " + sdcard);
                        return sdcard;
                    }
                }
                if (p.waitFor() != 0 && p.exitValue() == 1) {
                    // p.exitValue()==0表示正常结束，1：非正常结束
                    ViseLog.e(cmd + " 命令执行失败");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        ViseLog.i("not find sd card path return default:   " + sdcard);
        return sdcard;
    }
