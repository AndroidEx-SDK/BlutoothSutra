 ...
 */
package com.androidex.utils.io;

import android.os.Build;

import com.androidex.utils.common.StringUtil1;
import com.androidex.utils.io.stream.ByteArrayOutputStream;
import com.androidex.utils.io.stream.StringBuilderWriter;
 ...
 *
 * @version $Id: IOUtil.java 1326636 2012-04-16 14:54:53Z ggregory $
 */
public class IOUtil {
     ...
     * before using {@link IOUtil#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see IOUtil#toByteArray(InputStream, int)
     * @since 2.1
     */
     ...
     *                                                      version 2.2 if the encoding is not
     *                                                      supported.
     * @since 1.1
     */
    ...
    public static InputStream toInputStream(String input, Charset encoding) {
        return new ByteArrayInputStream(StringUtil1.getBytes(input, Charsets.toCharset(encoding)));
    }
    ...
    public static InputStream toInputStream(String input, String encoding) throws IOException {
        byte[] bytes = StringUtil1.getBytes(input, Charsets.toCharset(encoding));
    ...
    public static void write(char[] data, OutputStream output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(StringUtil1.getBytes(new String(data), Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(String data, OutputStream output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(StringUtil1.getBytes(data, Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(StringBuffer data, OutputStream output, String encoding) throws IOException {
        if (data != null) {
            output.write(StringUtil1.getBytes(data.toString(), Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void writeLines(Collection<?> lines, String lineEnding, OutputStream output, Charset encoding)
        ...
        for (Object line : lines) {
            if (line != null) {
                output.write(StringUtil1.getBytes(line.toString(), cs));
            }
            output.write(StringUtil1.getBytes(lineEnding, cs));
        }
    }
